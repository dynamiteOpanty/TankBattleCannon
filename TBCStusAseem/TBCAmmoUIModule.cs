...
{
    [XmlRoot("TBCAmmoUIModule")]
    [Reloadable]
    public class TBCAmmoUIModule : BlockModule
    {
    ...
    public class TBCAmmoUIBehaviour : BlockModuleBehaviour<TBCAmmoUIModule>
    {
        ...
        private void GenerateUI()
        {
            ...
            ammoUI.transform.SetParent(TBCUI.transform);
